...
```{r}
pacman::p_load(tmap, sf, sp, DT, performance, reshape2,
               ggpubr, tidyverse)
```

## **The Data**

This exercise is a continuation of **Chapter 15: Processing and Visualising Flow Data (Hands-on Exercise 3)** and the following data will be used:
...
In this section, I will learn how to compute a distance matrix by using URA Master Plan 2019 Planning Subzone boundary in which I saved as an rds file called *mpsz*.
...
Above are 2 ways of doing the same thing.
...
The code chunk below is used to import *od_data* saved in Chapter 15 into R environment.
...
Use the code chunk below to display a preview of flow_data dataframe.
...
In this section, I will learn how to calibrate Spatial Interaction Models by using Poisson Regression method.
...
Note that the distribution is highly skewed and does not resemble bell shape or also known as normal distribution.
...
Note that their relationship hardly resemble linear relationship.
...
Since Poisson Regression is based on log and log 0 is undefined, it is important for us to ensure that there are no 0 values in the explanatory variables.
...
| 0.99 is arbitrary, just select a small non-zero value will do
...
We can see all the 0 values have been replaced by 0.99.

### **Unconstrained Spatial Interaction Model**

In this section, I will learn how to calibrate an unconstrained spatial interaction model by using `glm()` of Base Stats. The explanatory variables are origin population by different age cohort, destination population by different age cohort (i.e. *ORIGIN_AGE25_64*) and distance between origin and destination in km (i.e. *dist*).

The general formula of Unconstrained Spatial Interaction Model

![](image1.jpg){fig-align="left" width="393" height="55"}
...
![](image2.jpg){width="459" height="66"}
...
In this section, I will learn how to visualise the observed values and the fitted values.
...
Repeat the same step for Origin Constrained SIM (i.e. orcSIM)
...
Repeat the same step for Doubly Constrained SIM (i.e. dbcSIM)
