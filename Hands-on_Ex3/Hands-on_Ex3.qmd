...
In this hands-on exercise, I will learn how to build an OD matrix by using *Passenger Volume by Origin Destination Bus Stops* data set downloaded from LTA DataMall. By the end of this hands-on exercise, I will be able:
...
Let us display the *odbus* tibble data table by using the code chunk below.
...
It is a good practice for us to check for duplicating records.
